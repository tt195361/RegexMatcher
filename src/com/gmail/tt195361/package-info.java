/**
 * 正規表現が文字列と一致するかどうかを調べるプログラム {@link com.gmail.tt195361.RegexMatcher} について説明します。
 * {@link com.gmail.tt195361.RegexMatcher} は、実際に動作するある程度の大きさのプログラムで、それをどのように考えて作成したかを説明します。
 * <p>
 * このプログラムと説明を作成するにあたり、
 * <a
 ...
 * <p>
 * {@link com.gmail.tt195361.RegexMatcher} について、以下の内容を順に説明します。
 * <ul>
 ...
 * 以下のようになります。
 * <ol>
 *   <li>{@link com.gmail.tt195361.RegexMatcher} クラスのコンストラクタ
 *   	{@link com.gmail.tt195361.RegexMatcher#RegexMatcher(String)} を、正規表現の文型を表わす文字列を
 *   	引数として呼び出し、{@link com.gmail.tt195361.RegexMatcher} クラスのオブジェクトを作成します。</li>
 *   <li>作成した {@link com.gmail.tt195361.RegexMatcher} クラスのオブジェクトに対して、一致するかどうかを調べる
 *   	文字列を引数として　{@link RegexMatcher#match} メソッドを呼び出します。</li>
 *   <li>{@link RegexMatcher#match} メソッドは、{@link com.gmail.tt195361.MatchResult} クラスのオブジェクトを
 ...
 * <h2>プログラムの構成</h2>
 * <p>
 * {@link com.gmail.tt195361.RegexMatcher} プログラムは、以下の流れで動作します。
 * <ol>
 *   <li>{@link com.gmail.tt195361.RegexMatcher} クラスのコンストラクタ
 *   	{@link com.gmail.tt195361.RegexMatcher#RegexMatcher(String)} で受け取った正規表現の
 *   	文型を表わす文字列を解釈し、プログラム内で使用する表現を作成します。</li>
 *   <li>{@link com.gmail.tt195361.RegexMatcher#match} メソッドで指定された文字列に対して、
 ...
 *   <li>それぞれの正規表現の要素を表わすクラスは、抽象クラス {@link com.gmail.tt195361.RegexElement} から派生させます。</li>
 *   <li>. . . . .</li>
 * </ul>
 * <table
 * 		border="1" rules="all"
